...
public class SpellCheckerManagerTest {
	...
	public void testSpellCheck() {
		...
		assertEquals(s.spellCheck("input/invalidWordTextFile.txt"), "ArrayBasedList[Llamajeans]");
		assertEquals(s.spellCheck("input/complicatedWordTextFile.txt"), "ArrayBasedList[49ers, broski, brotendo, dogger, gotta, Llamajeans, me&'s, timeyo]");
	}
